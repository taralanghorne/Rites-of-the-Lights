...
public class ClickNextDialogueTwoSounds : MonoBehaviour
{
    ...
    public GameObject sound2; // sound effect to play when transitioning
    ...
    public void ClickChoiceSound()
    {
        ...
        sound2.SetActive(true); // makes new text/buttons appear
    }
